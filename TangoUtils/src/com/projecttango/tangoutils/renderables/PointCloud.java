...
public class PointCloud extends Renderable {
	...
	private volatile FloatBuffer mPointCloudBuffer = FloatBuffer.allocate(1000000);
	...
	public synchronized void UpdatePoints(ArrayList<FloatBuffer> pointCloudFloatBuffers) {
		...
		//	}
		  ...
		  mPointCloudBuffer = FloatBuffer.allocate(sum);

		  for (int i=0; i < pointCloudFloatBuffers.size(); i++) {
			  pointCloudFloatBuffers.get(i).rewind();
